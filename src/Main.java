...
static int mapRows = 11, mapCols = 11;
...
public static void mapInitialize() {
	...
	map[rand(0, 10)][rand(0, 10)] = "# "; map[rand(0, 10)][rand(0, 10)] = "# "; map[rand(0, 10)][rand(0, 10)] = "# "; map[rand(0, 10)][rand(0, 10)] = "# ";
	map[rand(0, 10)][rand(0, 10)] = "% "; map[rand(0, 10)][rand(0, 10)] = "% "; 
	map[rand(0, 10)][rand(0, 10)] = "$ ";
	map[rand(0, 10)][rand(0, 10)] = "? ";map[rand(0, 10)][rand(0, 10)] = "? ";
